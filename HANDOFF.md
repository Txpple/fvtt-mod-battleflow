...
committed and pushed** (main == origin/main). ✅ **RELEASED as v1.35.0 on 2026-09-10, then v1.35.1 the same day, then v1.36.0 the same night (the stale Shield fixed, a feature's area swept, the Spent Areas list)** — the reroll fixes (four dice under advantage, the dice animating, the popups closing at the click), the durability review, the cantrip window, the window tidies (the user:
