...
Hooks.on("createChatMessage", message => {
  ...
  // THE MOMENT is the gate's (events.js version 2): the `sneakDamage` record landing on this
  // message IS the resolve, and decide/moments.js publishes `sneak` from it.
