...
| **A post-roll "second die" rescue for a forgotten Advantage** | **Not shipping** (2026-09-01: "I don't want a rescue, I want proactivity"). The reminder is the gate before the roll. ONE carve-out, ruled 2026-09-25: Lucky's Advantage on an initiative rolled with no dialog (the carousel, Roll All) is offered after the roll, because no dialog exists to put the box in (RULINGS' register). | the user asking for it by name |
